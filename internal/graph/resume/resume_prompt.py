...
EXTRACT_INFO_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "      \"position\": \"string or null\", // e.g., \"Software Engineer\", \"Product Manager\", \"Data Analyst\", etc.\n"
        "      \"job_type\": \"string or null\", // e.g., \"Full-time\", \"Part-time\", \"Contract\", etc.\n"
        ...
        "      \"degree\": \"string or null\", // e.g., \"Bachelor\", \"Master\", \"PhD\", etc.\n"
        "      \"field_of_study\": \"string or null\", // e.g., \"Computer Engineering\", \"Business Administration\", \"Mechanical Engineering\", etc.\n"
        "      \"start_date\": \"string or null\",\n"
        "      \"end_date\": \"string or null\",\n"
        "      \"description\": \"string or null\"\n"
        "    }}\n"
        ...
        "```\n\n"
        "**PARSING GUIDELINES:**\n"
        "1. **Names**: Extract first and last name, handle multiple formats\n"
        "2. **Contact**: Look for email, phone, address, LinkedIn, GitHub\n"
        "3. **Experience**: Extract as objects with company, position, job_type, start_date, end_date, and description. Parse dates in MM/YYYY or YYYY format when possible.\n"
        "4. **Education**: Extract as objects with school, degree, field_of_study, start_date, end_date, and description. Parse graduation dates when available.\n"
