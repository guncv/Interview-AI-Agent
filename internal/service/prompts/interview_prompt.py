...
ASK_EXPERIENCE_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "   - Set `next_step = \"ASK_EXPERIENCE\"`, `go_to_next_step = false`\n\n"

        "6. **If transitioning to project step (limits reached or no more questions)**:\n"
...
ASK_PROJECT_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "6. **If transitioning to technical step (limits reached or no more questions)**:\n"
