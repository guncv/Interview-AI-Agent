...
# from internal.utils.exception import validation_exception_handler, response_validation_exception_handler
# from internal.routes.router import api_router
...
# app.include_router(api_router, prefix=api_config.get("API_PREFIX", "/api/v1"))
